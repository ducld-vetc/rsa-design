...
interface StepperCSKHProps {
  currentStep: Step;
  servicePackage?: string;
}

const StepperCSKH: React.FC<StepperCSKHProps> = ({ currentStep, servicePackage }) => {
  const allSteps = [
    { id: Step.CUSTOMER_INFO, label: 'Thông tin khách hàng' },
    { id: Step.PAYMENT_QR, label: 'Thanh toán' },
    { id: Step.CONFIRMATION, label: 'Hoàn thành' }
  ];

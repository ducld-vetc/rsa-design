...
const guideSheet = XLSX.utils.aoa_to_sheet([
  ...
  ['scope.objectType', 'SUPPLIER_INTERNAL | SUPPLIER_EXTERNAL | CUSTOMER_INDIVIDUAL | CUSTOMER_BUSINESS'],
  ['scope.orderType', 'PACKAGE | SINGLE | PACKAGE_SINGLE'],
  ['validFrom', 'Ngày hiệu lực từ (YYYY-MM-DD)'],
  ['validTo', 'Ngày hiệu lực đến (YYYY-MM-DD)'],
  ['enterpriseCode', 'Mã DN — bắt buộc khi kind=CUSTOMER_BUSINESS'],
  ['supplierId', 'Mã NCC — bắt buộc khi kind=SUPPLIER_EXTERNAL'],
  ['supplierName', 'Tên NCC (tùy chọn)'],
  ['retailMarkupFactor', 'Hệ số giá khách lẻ (0 = không dùng; >0 chỉ với CUSTOMER_RETAIL markup-only)'],
...
const infoSheet = XLSX.utils.aoa_to_sheet([
  ...
  ['target', 'SUPPLIER'],
  ['scope.objectType', 'SUPPLIER_EXTERNAL'],
  ['scope.orderType', 'PACKAGE_SINGLE'],
  ['validFrom', '2026-01-01'],
  ['validTo', '2099-12-31'],
  ['enterpriseCode', ''],
  ['supplierId', 'NCC-001'],
  ['supplierName', 'NCC mẫu'],
